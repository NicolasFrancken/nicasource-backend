...
const videosControllers = __importStar(require("../controllers/videos-controllers"));
const router = express_1.default.Router();
const { getPublishedVideos, getVideosByCreatorId, getVideoByVideoId, createVideo, updateVideo, deleteVideo, publishVideo, likeVideo, } = videosControllers;
